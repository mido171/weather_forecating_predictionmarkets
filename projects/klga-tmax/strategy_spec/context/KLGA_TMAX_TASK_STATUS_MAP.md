...
- code under `bootstrap/klga_tmax/implementation/src/klga_tmax`
- tests under `bootstrap/klga_tmax/implementation/tests`
...
- deep-dive implementation document under `strategy_spec/context`
