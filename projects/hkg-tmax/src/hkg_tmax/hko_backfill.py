...
SATELLITE_MANIFEST_DOWNLOADS: tuple[HkoDownload, ...] = (
    ...
    HkoDownload(
        "hko_satellite_frontend_init_js",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/en/wxinfo/intersat/satellite/js/files/init.js",
        "js",
        "HKO satellite frontend initialization script with current image URL rules",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_frontend_control2_js",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/en/wxinfo/intersat/satellite/js/files/n_control2.js",
        "js",
        "HKO satellite frontend control script with legacy image URL rules",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_frontend_menu_js",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/en/wxinfo/intersat/satellite/js/files/menu_n_uc.js",
        "js",
        "HKO satellite frontend menu script with product metadata",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_infrared_h8_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/infrared_h8_img.js",
        "js",
        "HKO current Himawari infrared image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_deepconvection_fy4b_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/deepconvection_fy4b_img_15min.js",
        "js",
        "HKO current FY-4B deep-convection image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_deepconvection_h8_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/deepconvection_h8_img.js",
        "js",
        "HKO current Himawari deep-convection image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_infrared_fy4b_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/infrared_fy4b_img_15min.js",
        "js",
        "HKO current FY-4B infrared image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_truecolour_h8_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/truecolour_h8_img.js",
        "js",
        "HKO current Himawari true-colour image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_truecolour_fy4b_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/truecolour_fy4b_img_15min.js",
        "js",
        "HKO current FY-4B true-colour image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_alldayvisible_h8_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/alldayvisible_h8_img.js",
        "js",
        "HKO current Himawari all-day visible image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
        "hko_satellite_current_aerosolopticaldepth_gk2b_manifest",
        HKO_PROVIDER,
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/aerosolopticaldepth_gk2b_img.js",
        "js",
        "HKO current GK2B aerosol optical depth image manifest",
        {"family": "H_satellite_cloud_aerosol_observations", "point_in_time_class": "METADATA"},
    ),
    HkoDownload(
...
SATELLITE_CURRENT_IMAGE_BASE_URL = "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/images/"
SATELLITE_CURRENT_IMAGE_SPECS: tuple[tuple[str, str, str], ...] = (
    (
        "hko_satellite_current_infrared_h8_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/infrared_h8_img.js",
        "HKO current Himawari infrared image",
    ),
    (
        "hko_satellite_current_deepconvection_fy4b_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/deepconvection_fy4b_img_15min.js",
        "HKO current FY-4B deep-convection image",
    ),
    (
        "hko_satellite_current_deepconvection_h8_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/deepconvection_h8_img.js",
        "HKO current Himawari deep-convection image",
    ),
    (
        "hko_satellite_current_infrared_fy4b_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/infrared_fy4b_img_15min.js",
        "HKO current FY-4B infrared image",
    ),
    (
        "hko_satellite_current_truecolour_h8_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/truecolour_h8_img.js",
        "HKO current Himawari true-colour image",
    ),
    (
        "hko_satellite_current_truecolour_fy4b_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/truecolour_fy4b_img_15min.js",
        "HKO current FY-4B true-colour image",
    ),
    (
        "hko_satellite_current_alldayvisible_h8_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/alldayvisible_h8_img.js",
        "HKO current Himawari all-day visible image",
    ),
    (
        "hko_satellite_current_aerosolopticaldepth_gk2b_image",
        "https://www.hko.gov.hk/wxinfo/intersat/satellite/image/data/aerosolopticaldepth_gk2b_img.js",
        "HKO current GK2B aerosol optical depth image",
    ),
)
...
def _extract_satellite_filenames(js_text: str) -> list[str]:
    filenames: list[str] = []
    for match in re.finditer(r'"([^"\\]+\.(?:png|jpg|gif))"', js_text, flags=re.IGNORECASE):
...
def _satellite_image_extension(filename: str) -> str:
    suffix = Path(filename).suffix.lower().lstrip(".")
    return suffix if suffix in {"gif", "jpg", "jpeg", "png"} else "bin"


async def _filter_resolvable_satellite_downloads(
    downloads: Iterable[HkoDownload],
    *,
    concurrency: int = 16,
) -> tuple[HkoDownload, ...]:
    ...
    async with httpx.AsyncClient(
        ...
        async def is_resolvable(download: HkoDownload) -> HkoDownload | None:
        ...
        results = await asyncio.gather(*(is_resolvable(download) for download in downloads))
    return tuple(download for download in results if download is not None)
...
def build_satellite_downloads() -> tuple[HkoDownload, ...]:
    ...
    with httpx.Client(timeout=60.0, follow_redirects=True, verify=httpx_verify_context()) as client:
        current_candidates: list[HkoDownload] = []
        for source_id, manifest_url, description in SATELLITE_CURRENT_IMAGE_SPECS:
            js_text = client.get(manifest_url).text
            for filename in _extract_satellite_filenames(js_text):
                image_url = SATELLITE_CURRENT_IMAGE_BASE_URL + filename
                current_candidates.append(
                    HkoDownload(
                        source_id,
                        HKO_PROVIDER,
                        image_url,
                        _satellite_image_extension(filename),
                        description,
                        {
                            ...
                            "manifest_url": manifest_url,
                            "filename": filename,
                            "image_base_url": SATELLITE_CURRENT_IMAGE_BASE_URL,
                        },
                    )
                )
        downloads.extend(asyncio.run(_filter_resolvable_satellite_downloads(current_candidates)))
        for source_id, manifest_url, base_url, extension, description in manifest_specs:
            js_text = client.get(manifest_url).text
            legacy_candidates: list[HkoDownload] = []
            for filename in _extract_satellite_filenames(js_text):
            ...
            downloads.extend(asyncio.run(_filter_resolvable_satellite_downloads(legacy_candidates)))
    return tuple(downloads)
...
def _successful_archive_urls(data_root: Path) -> set[str]:
...
def run_hko_backfill_batch(
    ...
    *,
    ...
    skip_existing_successes: bool = False,
    max_requests: int = 1,
) -> HkoBackfillOutcome:
    if max_requests < 1:
    ...
    successful_urls = _successful_archive_urls(data_root) if skip_existing_successes else set()
    policy = _default_policy()
    attempted_fetches = 0
    for item in downloads:
        if item.url in successful_urls:
            skipped += 1
            continue
        if attempted_fetches >= max_requests:
            break
        attempted_fetches += 1
        if attempted_fetches > 1 and delay_seconds > 0:
