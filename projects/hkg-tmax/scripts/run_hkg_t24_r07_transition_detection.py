...
EXPERIMENT_DIR = PROJECT_PATHS.run_root / "experiments" / "legacy" / "hkg_tmax_t24" / "EXP-0039-HKG-T24-R07"
...
def write_report(
    ...
    write_text(
        PROJECT_PATHS.run_root / "reports" / "hkg_t24" / "R07_TRANSITION_DETECTION.md",
        long_report(payload)
