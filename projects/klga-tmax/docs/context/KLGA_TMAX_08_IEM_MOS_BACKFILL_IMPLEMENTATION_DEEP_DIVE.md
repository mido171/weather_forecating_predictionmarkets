...
cutoff_id: T_1245UTC
database: configured through the ignored `KLGA_DB_URL` environment variable
...
```powershell
$env:KLGA_DB_URL='postgresql://<user>:<password>@127.0.0.1:5432/klga_tmax_research'
...
| `KLGA_DB_URL` | Python materializer DB URL | Ignored local environment; no repository default. |
