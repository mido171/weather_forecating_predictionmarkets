...
- active polling start: `None`
- watched candidate dates: `[]`
...
- metrics JSON: `C:\Users\ahmad\Desktop\generalFiles\git\weather_markets\weather_data_extraction\bootstrap\hkg_tmax_elite_codex_bootstrap\hkg_tmax_elite_codex\experiments\EXP-0004-g1-daily-extract-bounded-polling-candidate-gating\results\metrics.json`
