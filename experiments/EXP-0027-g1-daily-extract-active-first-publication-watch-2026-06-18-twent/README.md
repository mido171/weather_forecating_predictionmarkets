# EXP-0027 — G1 Daily Extract active first-publication watch 2026-06-18 twenty-second continuation

**Status:** ACCEPTED
**Created:** 2026-06-18T20:53:29.978325Z
**Goal dependency:** G1 settlement truth / Daily Extract first-publication evidence
**Owner:** Codex

## Plain-language question

Does the twenty-second continuation of the active HKO Daily Extract watch
...
EXP-0026 kept `2026-06-18` absent through
`2026-06-18T20:50:08.714392Z`. EXP-0027 continues the same active watch with
the same bounded retry-backed polling protocol and a new metrics artifact.

## Current conclusion

Accepted as a G1 checkpoint only. The twenty-second continuation poll completed
six iterations; `2026-06-18` remained absent through
`2026-06-18T20:57:57.421862Z`, so G1 remains blocked.
