...
{
  "test": {
    "bias": 0.28903693848527656,
    "corr": 0.9910215768835062,
    "mae": 1.759011850008904,
    "maxAE": 9.366416024614885,
    "medianAE": 1.4013714739587897,
    "n": 332,
    "rmse": 2.3302382791372347
  },
  "train": {
    "bias": 5.733905724952695e-12,
    "corr": 0.9985634551362155,
    "mae": 0.6756171797123455,
    "maxAE": 6.953032082069669,
    "medianAE": 0.5511967145200032,
    "n": 1224,
    "rmse": 0.8875382777131678
  },
  "validation": {
    "bias": -0.20203014423792084,
    "corr": 0.9920796410600152,
    "mae": 1.9163054434163567,
    "maxAE": 7.736142078483802,
    "medianAE": 1.5607988024485877,
    "n": 214,
    "rmse": 2.4835327134980627
  }
}
```
...
```json
{
  ...
  "experiment": {
    "derived_features": {
      "formulas": [
        {
          "formula": "P(|resid_ens_mean| > q90_train)",
          "name": "p_hard_day"
        }
      ],
      "imputation": {
        "fill_values": {
          ...
          "p_hard_day": 0.06654461865036299,
      ...
      "train_fitted": [
        {
          ...
          "threshold": 4.85868793059317
        }
      ]
    },
    "description": "Predicted hard-day probability",
    "experiment_id": "E35",
    "feature_columns": [
      "nbm_tmax_f",
      "gfs_tmax_f",
