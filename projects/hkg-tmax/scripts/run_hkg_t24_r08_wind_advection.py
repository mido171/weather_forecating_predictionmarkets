...
EXPERIMENT_DIR = PROJECT_PATHS.run_root / "experiments" / "legacy" / "hkg_tmax_t24" / "EXP-0040-HKG-T24-R08"
...
def write_report(
    ...
    write_text(
        PROJECT_PATHS.run_root / "reports" / "hkg_t24" / "R08_WIND_ADVECTION.md",
        long_report(payload)
