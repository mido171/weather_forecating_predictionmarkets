"""Train a tree model on MOS feature CSV and emit JSON report."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train MOS model with fixed date split.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    output_path = Path(args.output) if args.output else csv_path.parent / "mos_train_report.json"
