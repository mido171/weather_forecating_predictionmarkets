...
from klga_tmax.config import ConfigError, load_project_env
...
def load_wunderground_settings(*, require_api_key: bool = False) -> WundergroundSettings:
    ...
    return WundergroundSettings(
        ...
        max_retries=_int_env("WUNDERGROUND_API_MAX_RETRIES", 2, minimum=0),
        rate_limit_per_minute=_int_env("WUNDERGROUND_API_RATE_LIMIT_PER_MINUTE", 30, minimum=1),
        max_workers=_int_env("WUNDERGROUND_MAX_WORKERS", 1, minimum=1),
        chunk_days=_int_env("WUNDERGROUND_CHUNK_DAYS", 7, minimum=1),
