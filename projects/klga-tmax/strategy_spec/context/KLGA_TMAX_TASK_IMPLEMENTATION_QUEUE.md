...
2. Source code under `implementation/src/klga_tmax`.
3. Tests under `implementation/tests`.
...
7. A deep-dive implementation document under `strategy_spec/context`.
...
Then run the task-specific command and validation added by the task.
