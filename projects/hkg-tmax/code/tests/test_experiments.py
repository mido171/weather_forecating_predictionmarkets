...
from hkg_tmax.experiments import EXPERIMENT_CONTROL_DIR, create_experiment, generate_index
...
def test_create_experiment_from_template(repo_root, tmp_path) -> None:
    ...
    shutil.copytree(
        repo_root / "experiments" / EXPERIMENT_CONTROL_DIR / "_template",
        control_root / "_template",
    )
