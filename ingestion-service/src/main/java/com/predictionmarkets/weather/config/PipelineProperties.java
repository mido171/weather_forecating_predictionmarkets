...
public class PipelineProperties {
  ...
  public boolean isAllowNonstandardRange() {
    return allowNonstandardRange;
  }

  public void setAllowNonstandardRange(boolean allowNonstandardRange) {
    this.allowNonstandardRange = allowNonstandardRange;
  }
}
