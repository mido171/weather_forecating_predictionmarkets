# EXP-0025 — G1 Daily Extract active first-publication watch 2026-06-18 twentieth continuation

**Status:** ACCEPTED
**Created:** 2026-06-18T20:37:47.348219Z
**Goal dependency:** G1 settlement truth / Daily Extract first-publication evidence
**Owner:** Codex

## Plain-language question

Does the twentieth continuation of the active HKO Daily Extract watch capture a
...
EXP-0024 kept `2026-06-18` absent through
`2026-06-18T20:33:50.378189Z`. EXP-0025 continues the same active watch with
the same bounded retry-backed polling protocol and a new metrics artifact.

## Current conclusion

Accepted as a G1 checkpoint only. The twentieth continuation poll completed
six iterations; `2026-06-18` remained absent through
`2026-06-18T20:42:02.053116Z`, so G1 remains blocked.
