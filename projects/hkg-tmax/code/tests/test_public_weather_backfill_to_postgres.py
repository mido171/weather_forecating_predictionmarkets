...
def test_optimized_cli_defaults_are_opt_in() -> None:
    ...
    assert optimized.model_fetch_workers == 8
    assert optimized.model_range_workers == 4
    assert optimized.model_normalize_workers == 2
    assert optimized.himawari_workers == 8
