...
- final catalog retrieved_at: `2026-06-18T18:55:38.923550Z`
- final catalog hash:
  `f80772b68545c56e6842c34998696fd11b7b9a80c0088bb1f6e4da65102616eb`
- final monthly retrieved_at: `2026-06-18T18:55:41.260103Z`
- final monthly hash:
...
An initial verifier attempt checked for HTTP fields under an incorrect nested
key and failed. Inspecting the sidecar showed the repository contract stores
those fields under `metadata`, after which the corrected verifier passed with no
archive problems.
...
- pytest: `59 passed`
- validate all: `PASS` with expected G1/G2 warnings
