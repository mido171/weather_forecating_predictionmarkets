# EXP-0030 - G1 Daily Extract active first-publication watch 2026-06-18 twenty-fifth continuation

**Status:** ACCEPTED
**Created:** 2026-06-18T21:24:30.468937Z
**Goal dependency:** G1 settlement truth / Daily Extract first-publication evidence
**Owner:** Codex

## Plain-language question

Does the twenty-fifth continuation of the active HKO Daily Extract watch capture
...
EXP-0029 kept `2026-06-18` absent through
`2026-06-18T21:21:19.382593Z`. EXP-0030 continues the same active watch with
the same bounded retry-backed polling protocol and a new immutable metrics
artifact.

## Current conclusion

Accepted as a G1 checkpoint only. The twenty-fifth continuation poll completed
six iterations; `2026-06-18` remained absent through
`2026-06-18T21:29:42.956957Z`, so G1 remains blocked.
