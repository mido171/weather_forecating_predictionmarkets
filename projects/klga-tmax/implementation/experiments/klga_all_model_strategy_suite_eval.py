...
def db_config() -> dict[str, object]:
    return {
        "host": os.environ.get("KLGA_DB_HOST", "127.0.0.1"),
        "port": int(os.environ.get("KLGA_DB_PORT", "5432")),
        "dbname": os.environ.get("KLGA_DB_NAME", "klga_tmax_research"),
        "user": os.environ.get("KLGA_DB_USER", "postgres"),
        "password": os.environ.get("KLGA_DB_PASSWORD", "root"),
    }
