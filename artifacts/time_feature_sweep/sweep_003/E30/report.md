...
{
  "test": {
    "bias": 0.282234265340325,
    "corr": 0.991783060928958,
    "mae": 1.702649540245006,
    "maxAE": 9.238314920452247,
    "medianAE": 1.3923854290177076,
    "n": 332,
    "rmse": 2.230341436462057
  },
  "train": {
    "bias": 6.07978852447862e-11,
    "corr": 0.9990274932415664,
    "mae": 0.5439200515483437,
    "maxAE": 6.807797743070488,
    "medianAE": 0.44112529033282755,
    "n": 1224,
    "rmse": 0.7305968173011907
  },
  "validation": {
    "bias": -0.424815529693875,
    "corr": 0.9920095807914712,
    "mae": 1.914551021702774,
    "maxAE": 8.339263164967505,
    "medianAE": 1.4607438591907709,
    "n": 214,
    "rmse": 2.5296315840292154
  }
}
```
...
```json
{
  "top_features": [
    ...
    {
      "feature": "winner_streak_len_l1",
      "importance": 322.0
    },
    {
      "feature": "winner_switch_count_30_l1",
      "importance": 91.0
    },
    {
      "feature": "is_weekend",
  ...
  "experiment": {
    "derived_features": {
      "formulas": [
        ...
        {
          "formula": "forecast(winner_id)",
          "name": "winner_forecast_today"
        },
        {
          "formula": "switch_count(winner_id)",
          "name": "winner_switch_count_30_l1",
          "params": {
            "lag": 1,
            "min_periods": 21,
            "window": 30
        ...
        {
          "formula": "streak_length(winner_id)",
          "name": "winner_streak_len_l1",
          "params": {
            "cap": 60,
            "lag": 1
          }
      ...
      "imputation": {
        "fill_values": {
          ...
          "winner_forecast_today": 64.29198242187508,
          "winner_streak_len_l1": 28.0,
          "winner_switch_count_30_l1": 0.0
        },
        "method": "train_median"
      },
      "train_fitted": []
    },
    "description": "Dynamic model switching + switch frequency",
    "experiment_id": "E30",
    "feature_columns": [
      "nbm_tmax_f",
      "gfs_tmax_f",
