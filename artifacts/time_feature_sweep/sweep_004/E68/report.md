...
{
  "test": {
    "bias": 0.47118407784567246,
    "corr": 0.9908684133336783,
    "mae": 1.8267771942483686,
    "maxAE": 9.669262252074134,
    "medianAE": 1.4449031295736638,
    "n": 332,
    "rmse": 2.380365023482188
  },
  "train": {
    "bias": 9.392333534013268e-11,
    "corr": 0.9986136010391655,
    "mae": 0.6590454332068515,
    "maxAE": 6.865580622074656,
    "medianAE": 0.5369687388509661,
    "n": 1224,
    "rmse": 0.8719370203945173
  },
  "validation": {
    "bias": 0.04853843037975029,
    "corr": 0.9918899100939964,
    "mae": 1.9355337422982422,
    "maxAE": 7.951497406973239,
    "medianAE": 1.6303011645257293,
    "n": 214,
    "rmse": 2.5525208116422724
  }
}
```
...
```json
{
  ...
  "experiment": {
    "derived_features": {
      "formulas": [
        {
          "formula": "page_hinkley_stat",
          "name": "ph_stat_l2"
        },
        {
          "formula": "page_hinkley_alarm",
          "name": "ph_alarm_l2"
        }
      ],
      "imputation": {
      ...
      "train_fitted": [
        {
          ...
          "thresholds": {
            "KNYC": 290.3385025055613
          }
        }
      ]
    },
    "description": "Page-Hinkley drift statistic",
    "experiment_id": "E68",
    "feature_columns": [
      "nbm_tmax_f",
      "gfs_tmax_f",
